...
export const DEFAULT_ROUTING_MATRIX: RoutingMatrix = {
  ...
  normal: {
    ...
    planning: { candidates: ["gemma-4-31b-it", "gemma-4-26b-a4b-it", "gemini-3.6-flash", "claude-3-5-haiku-20241022"], maxTokens: 4096, ceilingCents: -1 },
  },
  low_compute: {
    agent_turn: { candidates: ["gemma-4-26b-a4b-it", "gemma-4-31b-it", "gemini-3.6-flash", "claude-3-5-haiku-20241022"], maxTokens: 4096, ceilingCents: 10 },
    heartbeat_triage: { candidates: ["gemma-4-26b-a4b-it", "gemini-3.6-flash", "claude-3-5-haiku-20241022"], maxTokens: 1024, ceilingCents: 2 },
    safety_check: { candidates: ["gemma-4-26b-a4b-it", "gemini-3.6-flash", "claude-3-5-haiku-20241022"], maxTokens: 2048, ceilingCents: 5 },
    summarization: { candidates: ["gemma-4-26b-a4b-it", "gemini-3.6-flash", "claude-3-5-haiku-20241022"], maxTokens: 2048, ceilingCents: 5 },
    planning: { candidates: ["gemma-4-26b-a4b-it", "gemini-3.6-flash", "claude-3-5-haiku-20241022"], maxTokens: 2048, ceilingCents: 5 },
  },
  critical: {
    agent_turn: { candidates: ["gemma-4-26b-a4b-it", "gemma-4-31b-it", "gemini-3.6-flash"], maxTokens: 2048, ceilingCents: 3 },
    heartbeat_triage: { candidates: ["gemma-4-26b-a4b-it", "gemini-3.6-flash"], maxTokens: 512, ceilingCents: 1 },
    safety_check: { candidates: ["gemma-4-26b-a4b-it", "gemini-3.6-flash"], maxTokens: 1024, ceilingCents: 2 },
