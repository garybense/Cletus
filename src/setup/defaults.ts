...
## Capabilities
- Shell execution in Mindmods sandbox
- Mindmods API integration (credits, sandboxes, inference)
...
const SKILL_COMPUTE = `---
name: mindmods-compute
description: "Manage Mindmods sandboxes and compute resources"
auto-activate: true
---
# Mindmods Compute Management
...
2. Check Mindmods credits with \`check_credits\`
...
const DEFAULT_SKILLS: { dir: string; content: string }[] = [
  { dir: "mindmods-compute", content: SKILL_COMPUTE },
  { dir: "mindmods-payments", content: SKILL_PAYMENTS },
