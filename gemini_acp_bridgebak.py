...
# Configuration
# API key from .env (propagated by gateway)
API_KEY = os.environ.get("GOOGLE_API_KEY", "")
# Use models/gemini-3.6-flash as recommended by previous API error
...
class GeminiAgent:
    def __init__(self):
        ...
        self.mcp_clients = {}
        self.history = []
        self.available_models = [{"modelId": MODEL, "name": "Gemini 3.6 Flash"}]
